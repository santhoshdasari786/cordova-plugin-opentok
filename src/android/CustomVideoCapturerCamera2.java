...
/**
 * Created by Santhosh D S on 28-05-2020.
 */
@TargetApi(21)
@RequiresApi(21)
public class CustomVideoCapturerCamera2 extends BaseVideoCapturer implements BaseVideoCapturer.CaptureSwitch {
    ...
    private CameraDevice.StateCallback cameraObserver = new CameraDevice.StateCallback() {
        ...
        public void onDisconnected(CameraDevice camera) {
            try {
                ...
                cameraErrorListener.callback("camera disconnected");

                CustomVideoCapturerCamera2.this.camera.close();
            } catch (NullPointerException e) {
                Log.d(LOG_TAG,"CameraAccessException onFailed9");
        ...
        public void onError(CameraDevice camera, int error) {
            Log.d(LOG_TAG,"CameraDevice onError 1 "+error);
            Log.d(LOG_TAG,"CameraDevice onError 2 "+camera.toString());
            ...
            try {
                ...
                // does nothing
                Log.d(LOG_TAG,"CameraAccessException onFailed10");
            }
            ...
            new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(CameraCaptureSession session) {
                    ...
                    try {
                        ...
                        Log.d(LOG_TAG,"CameraAccessException onFailed1");
    ...
    public CustomVideoCapturerCamera2(Context ctx,
                                      ...
                                      Publisher.CameraCaptureFrameRate fps ,CameraErrorListener cameraErrorListener ) {
        ...
        try {
            ...
            Log.d(LOG_TAG,"CameraAccessException onFailed2");
    ...
    private int doStartCapture() {
        ...
        try {
            ...
            Log.d(LOG_TAG,"CameraAccessException doStartCapture exit");
    ...
    public synchronized int stopCapture() {
        ...
        if (null != camera && null != captureSession && CameraState.CLOSED != cameraState) {
            ...
            try {
                ...
                Log.d(LOG_TAG,"CameraAccessException onFailed3");
                e.printStackTrace();
            }
    ...
    public void onResume() {
        Log.d(LOG_TAG,"onResume " +"CUSTOM "+isPaused);
        if (isPaused) {
            Runnable resume = () -> {
                initCamera();
                startCapture();
    ...
    public synchronized void cycleCamera() {
        try {
            ...
            Log.d(LOG_TAG,"CameraAccessException onFailed4");
            e.printStackTrace();
            throw new Camera2Exception(e.getMessage());
        }
    }
    ...
    private void stopCamThread() {
        try {
            ...
            Log.d(LOG_TAG,"CameraAccessException onFailed5");
            e.printStackTrace();
        } catch (NullPointerException e) {
            Log.d(LOG_TAG,"CameraAccessException onFailed6");
            // does nothing
        } finally {
            Log.d(LOG_TAG,"CameraAccessException onFailed7");
            cameraThread = null;
    ...
    private void initCamera() {
        ...
        try {
            ...
            Log.d(LOG_TAG,"CameraAccessException onFailed8");
